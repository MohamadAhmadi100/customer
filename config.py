...
class Config:
    ...
    RAKIANO_SMS_TEMPLATE: str = os.getenv('RAKIANO_SMS_TEMPLATE')
    SMS_CANCEL_STATUS_TEMPLATE: str = os.getenv('SMS_CANCEL_STATUS_TEMPLATE')
    RAKIANO_SMS_CANCEL_STATUS_TEMPLATE: str = os.getenv('RAKIANO_SMS_CANCEL_STATUS_TEMPLATE')
    SMS_ACTIVATE_TEMPLATE: str = os.getenv('SMS_ACTIVATE_TEMPLATE')
    RAKIANO_SMS_ACTIVATE_TEMPLATE: str = os.getenv('RAKIANO_SMS_ACTIVATE_TEMPLATE')
    SMS_REGISTER_TEMPLATE: str = os.getenv('SMS_REGISTER_TEMPLATE')
    RAKIANO_SMS_REGISTER_TEMPLATE: str = os.getenv('RAKIANO_SMS_REGISTER_TEMPLATE')
...
VALID_GRID_KEYS = ["customerID", "customerFirstName", "customerLastName", "customerMobileNumber",
                   "customerJalaliCreateTime", "customerStatus", "customerNationalID", "customerTypes"]
